# This repository has been archived, it's now hosted in the repository [contrib/checkbox-provider-ce-oem](https://github.com/canonical/checkbox/tree/main/contrib/checkbox-provider-ce-oem)
